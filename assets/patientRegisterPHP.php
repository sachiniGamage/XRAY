<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($result) {
            header("Location:../patientRegister.php?update=success");
        } else {
            header("Location:../patientRegister.php?update=fail");
        }
    } else {
        header("Location:../patientRegister.php?Error=No_Access");
    }
  } else {
        header("Location:../patientRegister.php?update=failss");
    }