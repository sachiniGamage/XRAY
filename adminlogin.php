    ...
    <div class="column">
                    <div class="col-md-5 col-sm-5 form_section">
                         ...
                         <div style="padding:20px; background: #F2F1F0; border-radius:2rem">
                              <form id="login-form" role="form" method="post" action="assets/admin/adminregisterPHP.php">
                                   <div class="mb-3" style="margin-bottom:20px">
                                        <label for="login_email" class="form-label"
                                             style="margin-bottom:10px; margin-top:">Email address</label>
                                        <input type="email" class="form-control" id="admin_email"
                                             aria-describedby="emailHelp" name="admin_email" required>
                                   </div>
                                   <div class="mb-3" style="margin-bottom:20px">
                                   ...
                                   <div class="mb-3" style="margin-bottom:20px">
                                        ...
                                        <input type="password" class="form-control" id="admin_conpass"
                                             name="admin_conpass" required>
                                   </div>
                                   <button name="registerAdmin" value="register" type="submit" class="btn"
     ...
     <div class="column">
                <div class="form-popup" id="AdminForm">
                    <div class="col-md-5 col-sm-5 form_section">
                         <h4 style="margin-bottom:3rem;">Admin Login</h4>
                         <div style="padding:20px; background: #F2F1F0; border-radius:2rem">
                              <form id="login-form" role="form" method="post" action="assets/admin/adminloginPHP.php">
                                   <div class="mb-3" style="margin-bottom:20px">
                                        <label for="login_email" class="form-label"
                                             style="margin-bottom:10px; margin-top:">Email address</label>
                                        <input type="email" class="form-control" id="admin_email"
                                   ...
                                   <button name="loginAdmin" value="login" type="submit" class="btn"
