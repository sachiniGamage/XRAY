...
<!-- Form Name -->
<legend><center><h2><b>Search-Patient</b></h2></center></legend><br>

<form method="post" action="viewForm.php">
  <input type="text" class="textbox" placeholder="Patient ID">
  <input title="Search" id="myInput" name="myInput" type="submit" class="button">
  <?php  print("$output"); ?>
</form>